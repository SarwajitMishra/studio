...
export const metadata: Metadata = {
  ...
  description: 'Understand how our app uses cookies to enhance your experience.',
};
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-4">
          ...
          <section>
            ...
            <p>Firebase Studio uses minimal cookies to ensure a smooth and functional gameplay experience. We do not use third-party cookies for advertising or invasive tracking. Our cookies fall into the following categories:</p>
            <ul>
