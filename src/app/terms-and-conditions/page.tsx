    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <Card className="shadow-lg">
        ...
        <CardContent className="prose prose-sm sm:prose-base dark:prose-invert max-w-none space-y-4">
          <p>Welcome to **Shravya PlayLab**! These terms and conditions outline the rules and regulations for the use of our gaming platform.</p>
          ...
          <section>
            ...
            <p>You agree to use Shravya PlayLab only for its intended purposes. The following activities are strictly prohibited:</p>
            <ul>
          ...
          <section>
            ...
            <p>S-Points and S-Coins are virtual reward points earned through gameplay. They are intended to enhance the gaming experience and do not hold any real-world monetary value, except where explicitly stated in the context of official gift contests or promotional events organized by Shravya PlayLab.</p>
          </section>

          <section>
            <h3>5. Account Security</h3>
            <p>You are responsible for safeguarding your login credentials. You must notify us immediately of any unauthorized use of your account. Shravya PlayLab cannot be held liable for any loss or damage arising from your failure to protect your account information.</p>
          </section>
          
          <section>
            <h3>6. Content Ownership and Intellectual Property</h3>
            <p>All game designs, artwork, characters, icons, and other content on the Shravya PlayLab platform are the exclusive property of Shravya PlayLab and are protected by copyright and other intellectual property laws, unless otherwise credited. You may not use any of our content without prior written consent.</p>
          </section>
          ...
          <section>
            ...
            <p>In no event shall Shravya PlayLab, nor its directors, employees, or agents, be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of the platform.</p>
          </section>
          ...
          <section>
            ...
            <p>For any questions or support inquiries regarding these terms, please contact us at: <a href="mailto:hello@shravya.foundation">hello@shravya.foundation</a></p>
          </section>
        </CardContent>
      </Card>
    </div>
