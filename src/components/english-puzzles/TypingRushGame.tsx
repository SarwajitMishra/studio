...
import { Keyboard, Heart, Trophy, Play, Pause, RotateCw, ArrowLeft, Loader2, Star as StarIcon, Award, Shrink } from "lucide-react";
...
export default function TypingRushGame({ onBack, difficulty }: TypingRushGameProps) {
            ...
            return (
                <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center z-20 backdrop-blur-sm text-center p-4">
                   ...
                   <div className="flex justify-center gap-4 mt-8">
                       <Button onClick={handleExit} variant="outline" size="lg">Change Puzzle</Button>
    ...
    return (
        <div ref={gameAreaRef} className={cn("w-full h-full flex items-center justify-center", isFullscreen && "bg-background")}>
